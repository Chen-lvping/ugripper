#ifndef MOTION_ALERT_IPC_H
#define MOTION_ALERT_IPC_H
...
constexpr uint32_t kMotionAlertMessageMagic = 0x4D414C54;  // MALT
...
static_assert(std::is_standard_layout<MotionAlertMessage>::value, "MotionAlertMessage must be standard layout");
