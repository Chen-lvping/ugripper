...
# ================= 变量定义区域 =================
APP_NAME="ugripper"
BASE_VERSION="${BASE_VERSION:-2.1.10}"
...
DEFAULT_PACKAGED_VENV_URL="http://nexus.dmrobot.com:8081/repository/dmrobot_raw_hosted/ugripper-v2-uv-venv/py311_v2.1.0/ugripper_venv_20260623_102954_arm64.tar.gz"
